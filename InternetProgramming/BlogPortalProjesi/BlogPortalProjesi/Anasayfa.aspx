  ...
  <body>
    ...
    <div class="container">
     ...
     %>
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"  SelectCommand="SELECT * FROM [makaleler] ORDER BY [makale_tarihi] DESC"></asp:SqlDataSource>
          <!-- eski yeri -->
