<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hakkinda.aspx.cs" Inherits="BlogPortalProjesi.Hakkinda" %>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Hakkinda.aspx">Hakkında</a></li>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div class="jumbotron">
                <%
                    ...
                    try { 
                        ...
                        komut.CommandText = "select hakkinda_baslik,hakkinda_icerik from hakkinda";
                        ...
                        foreach (DataRow bilgi in tablo.Rows)
                        {
                            if (!IsPostBack)
                            {
                                Response.Write("<h1>" + bilgi["hakkinda_baslik"].ToString() + "</h1>" + "<p>" + bilgi["hakkinda_icerik"].ToString() + "</p>"); 
                            }
                        }
                    }
                    catch (Exception ex)
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
              ...
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName  %>" SelectCommand="SELECT [kategori_adi], [kategori_ID] FROM [kategoriler]"></asp:SqlDataSource>
          </div>
        </div>
      </div>
