<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="BlogPortalProjesi.Anasayfa" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <title>Blog Portal Web Projesi</title>
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="sr-only">Kategori Görünümü</span>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <%
         ...
         komut.CommandText = "Select * from makaleler order by makale_ID DESC";
         ...
         if (!pds.IsFirstPage)
         {
             linkPrev.NavigateUrl = "Anasayfa.aspx?Sayfa=" + (currentPage - 1);
         }

         if (!pds.IsLastPage)
         {
             linkNext.NavigateUrl = "Anasayfa.aspx?Sayfa=" + (currentPage + 1);
         }
         ...
         else
         {
            ...
            Response.Write("Henüz hiç haber eklenmedi! Veri girişi yapabilmek için yönetici haklarına sahip olmalısınız. Bunun için lütfen <a href='login.aspx'>tıklayın.</a>");
         }
         baglanti.Close();
         baglanti.Dispose();     
     %>
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>"  SelectCommand="SELECT * FROM [makaleler] ORDER BY [makale_tarihi] DESC"></asp:SqlDataSource>
          <!-- eski yeri -->
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName  %>" SelectCommand="SELECT [kategori_ID], [kategori_adi] FROM [kategoriler]"></asp:SqlDataSource>
